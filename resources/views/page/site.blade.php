    ...
    <main>
        <section class="home">
            <article class="art_home">
                <header>
                    <img src="img/leo.png" alt="Foto do Desenvolvedor Leonardo G. França"
                        title="Foto do Desenvolvedor Leonardo G. França">
        ...
        <section class="about" id="about">
            ...
            <article>
                <p>Sou formado em Análise e Desenvolvimento de sistemas e estudante de diversos outros cursos online.
                    ...
                    para dar dicas sobre os meus codigos e dúvidas estou à disposição ;), Segue o link: <a
                        href="https://github.com/leofranca47" target="_blank">GitHub</a> </p>
            </article>
            ...
            <div class="portifolio-img">
                ...
                <article>
                    <a class="button" verify="relatorioEasy">
                        <img src="img/potifolio/easy_caixa/relátoriosG.png" alt="Tela de relátorios"
                            title="Tela de relátorios">
                    </a>
                </article>
                <article>
                    <a class="button" verify="graficoEasy">
                        <img src="img/potifolio/easy_caixa/graficosG.png" alt="Tela de relátorios"
                            title="Tela de relátorios">
                    </a>
                </article>
            </div>
            ...
            <div class="portifolio-img">
                <article>
                    <a class="button" verify="usuarioJiu">
                        <img src="img/potifolio/placar-jiujtsu/usuariosG.jpeg" alt="Tela de controle do placar"
                            title="Tela de controle do placar">
                    </a>
                </article>
                <article>
                    <a class="button" verify="lutadorJiu">
                        <img src="img/potifolio/placar-jiujtsu/tela-lutadoresG.jpeg"
                            alt="Tela de visão dos lutadores e juízes" title="Tela de visão dos lutadores e juízes">
                    </a>
                </article>
            </div>
        ...
        <section class="contact" id="contact">
            ...
            <div class="contact_article">
                <article>
                    <a href="https://www.facebook.com/leonardo.guimaraesfranca" target="_blank">
                        <p class="icon-facebook2">Meu Facebook</p>
                    </a>
                </article>
                <article>
                    <a href="https://www.instagram.com/leofranca47/?hl=pt-br" target="_blank">
                        <p class="icon-instagram">Meu Instagram</p>
                    </a>
                </article>
                <article>
                    <a href="https://github.com/leofranca47" target="_blank">
                        <p class="icon-github">Meu GitHub</p>
                    </a>
                </article>
                <article>
                    <a href="https://www.linkedin.com/in/leonardo-guimar%C3%A3es-fran%C3%A7a-3568b3108/" target="_blank">
                        <p class="icon-linkedin">Meu Linkedin</p>
                    </a>
                </article>
            </div>
        </section>
